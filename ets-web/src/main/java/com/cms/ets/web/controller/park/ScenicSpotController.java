...
public class ScenicSpotController extends BaseController {
    ...
    @PostMapping("save")
    @ApiOperation("保存")
    @OperationLog(action = OperateLogConstant.ADD, moduleName = ScenicSpot.MODULE_NAME, menuName = ScenicSpot.MENU_NAME)
    ...
    @PostMapping("update")
    @ApiOperation("更新")
    @OperationLog(action = OperateLogConstant.EDIT, moduleName = ScenicSpot.MODULE_NAME, menuName = ScenicSpot.MENU_NAME)
    ...
    @ApiOperation("删除")
    @OperationLog(action = OperateLogConstant.REMOVE, moduleName = ScenicSpot.MODULE_NAME, menuName = ScenicSpot.MENU_NAME)
