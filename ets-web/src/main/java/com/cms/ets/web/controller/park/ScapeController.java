...
public class ScapeController extends BaseController {
    ...
    @PostMapping("save")
    @ApiOperation("保存")
    @OperationLog(action = OperateLogConstant.ADD, moduleName = Scape.MODULE_NAME, menuName = Scape.MENU_NAME)
    ...
    @PostMapping("update")
    @ApiOperation("更新")
    @OperationLog(action = OperateLogConstant.EDIT, moduleName = Scape.MODULE_NAME, menuName = Scape.MENU_NAME)
    public HandleResult update(@RequestBody Scape scape) {
        scapeService.updateById(scape);
        return success();
    }
    ...
    @ApiOperation("删除")
    @OperationLog(action = OperateLogConstant.REMOVE, moduleName = Scape.MODULE_NAME, menuName = Scape.MENU_NAME)
